...
send_check_message = (
    'Пришлите чек (документом, т.е. без сжатия)\n\n'
    '❗В связи с учащением '
...
not_valid_image = (
    '❌Вы прислали некорректное изображение. Убедитесь что вы отправили изображение документом.'
)
...
def product_payout_message(data: Requisites, price):
    return (
        f'❗Комиссии с платежей не взимаются. Для оплаты вам необходимо '
